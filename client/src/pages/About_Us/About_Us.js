      ...
      <Container>
        <Row>
          ...
          <Col md={6}>
            ...
            <p>At QualityFare, we are a team of five passionate individuals who have come together to 
            ...
            to quality and healthy recipes that cater to all dietary needs.</p>

            <p>We are constantly innovating and evolving our platform to ensure that you have the best 
            possible experience. Our team is committed to providing excellent customer service, and 
            we welcome your feedback and suggestions on how we can make our web application even better.</p>

            <p>We hope that you enjoy using QualityFare as much as we enjoy creating it. Let's cook, 
            share, and eat together!</p>
